...
------------------------------------------------
/*DROP TRIGGER TG_Author_update
DROP TRIGGER TG_Author_insert
DROP TRIGGER TG_Author_delete
DROP TRIGGER TG_Users_insert_update
DROP TRIGGER TG_Users_insert
DROP TRIGGER TG_Users_update
DROP TRIGGER TG_Users_update_delete
DROP TRIGGER TG_Transactions_update
DROP TRIGGER TG_Transactions_insert
DROP TRIGGER TG_Audio_insert_update
DROP TRIGGER TG_Video_insert_update
DROP TRIGGER TG_PostAuthor_insert
DROP TRIGGER TG_PostAuthor_insert_update
DROP TRIGGER TG_SavePost_insert_update
DROP TRIGGER TG_Comment_delete
DROP TRIGGER TG_Comment_insert_update
DROP TRIGGER TG_Posts_insert
DROP TRIGGER TG_Position_delete
DROP TRIGGER TG_Employee_insert
DROP TRIGGER TG_Employee_delete
DROP TRIGGER TG_Employee_update
DROP TRIGGER TG_Customer_insert_update
DROP TRIGGER TG_Customer_delete
DROP TRIGGER TG_Posts_insert_update
DROP TRIGGER TG_Posts_delete*/
